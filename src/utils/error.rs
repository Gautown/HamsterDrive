...
// 实现从 toml::de::Error 的转换
impl From<toml::de::Error> for HamsterError {
    fn from(error: toml::de::Error) -> Self {
        HamsterError::ConfigError(error.to_string())
    }
}

// 实现从 toml::ser::Error 的转换
impl From<toml::ser::Error> for HamsterError {
...
impl From<rusqlite::Error> for HamsterError {
    fn from(error: rusqlite::Error) -> Self {
        HamsterError::DatabaseError(error.to_string())
    }
}
