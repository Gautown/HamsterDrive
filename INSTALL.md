...
### 使用批处理文件运行
您也可以直接双击项目目录中的批处理文件：
- [run.bat](file:///g%3A/GitHub/HamsterDrivers/run.bat) - 构建并运行项目
- [build.bat](file:///g%3A/GitHub/HamsterDrivers/build.bat) - 仅构建项目
